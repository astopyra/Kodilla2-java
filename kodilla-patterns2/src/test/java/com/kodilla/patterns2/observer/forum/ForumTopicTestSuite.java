...
public class ForumTopicTestSuite {
    ...
    void testUpdate(){
        ...
        ForumUser ivonEscobar = new ForumUser("Ivon Escobar");
        ForumUser jessiePinkman = new ForumUser("Jessie Pinkman");
        javaHelpForum.registerObserver(johnSmith);
        javaToolsForum.registerObserver(ivonEscobar);
        ...
        javaToolsForum.addPost("Help pls, mySQL db doesn't wanna work:(");
        ...
        assertEquals(2, ivonEscobar.getUpdateCount());
