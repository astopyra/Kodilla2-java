...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://astopyra.github.io";
...
/*
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        WebElement elUser = driverTrello.findElement(By.id("user"));
        elUser.sendKeys("astopyra@gmail.com");
        elUser.submit();

        Thread.sleep(4000);

        WebElement elPassword = driverTrello.findElement(By.id("password"));
        elPassword.sendKeys("Nowehas10;");
        elPassword.submit();
    ...
    private void deleteTaskfromApp(String taskName) {
        driver.navigate().refresh();
